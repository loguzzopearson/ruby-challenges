def user_birth_path_number(birthdate)
...
def path_message(birth_path_number)
...
puts "Hi there. Enter your birthdate like this MMDDYYYY."
birthdate = gets

birth_path_number = user_birth_path_number(birthdate)
message = path_message(birth_path_number)
puts message
